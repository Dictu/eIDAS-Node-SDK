...
public class Pkcs11Decrypter extends Decrypter {
	...
	public void setUseDefaultDecrypter(boolean useDefaultDecrypter) {
	 ...
	 /**
	     ...
	     */
	    public static boolean isRSAOAEP(final String keyTransportAlgorithm) {
	        return EncryptionConstants.ALGO_ID_KEYTRANSPORT_RSAOAEP.equals(keyTransportAlgorithm)
	                || EncryptionConstants.ALGO_ID_KEYTRANSPORT_RSAOAEP_11.equals(keyTransportAlgorithm);
	    }
	 ...
	 public Key decryptKey(EncryptedKey encryptedKey, String algorithm, Key kek) throws DecryptionException {
	   ...
	   if (!isRSAOAEP(encryptedKey.getEncryptionMethod().getAlgorithm())) {
	     return super.decryptKey(encryptedKey, algorithm, kek);
	   }
